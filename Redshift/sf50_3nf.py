        ...
        for i in range(0,13):
            ...
            for _ in range(0, n_query+1):
                ...
                while go and retry_count < 5:
                    ...
                    cursor.execute("select starttime, endtime, query from stl_query where querytxt like '"+queries_text_3nf[i]+"%' order by query desc limit 1")
