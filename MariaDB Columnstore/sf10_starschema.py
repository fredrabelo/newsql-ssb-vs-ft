...
queries_ss =  [
    ...
    "select sum(lo_revenue), d_year, p_brand from sf10.lineorder, sf10.dwdate, sf10.part, sf10.supplier where p_brand between 'MFGR#2221' and 'MFGR#2228' and lo_orderdate = d_datekey and lo_partkey = p_partkey and lo_suppkey = s_suppkey and s_region = 'ASIA' group by d_year, p_brand order by d_year, p_brand;",
